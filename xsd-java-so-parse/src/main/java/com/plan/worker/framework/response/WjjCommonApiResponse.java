package com.plan.worker.framework.response;

import com.plan.worker.response.WjjApiResponseCode;
import com.plan.worker.framework.exception.WjjApiException;
import com.plan.worker.framework.exception.WjjApiValidException;
import lombok.Data;
...
public class WjjCommonApiResponse implements Serializable {
    ...
    public WjjCommonApiResponse error(String message) {
