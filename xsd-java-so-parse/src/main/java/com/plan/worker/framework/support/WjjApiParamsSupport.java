package com.plan.worker.framework.support;
...
import com.plan.worker.framework.utils.AspectUtil;
import com.plan.worker.framework.utils.ValidatorUtils;
...
public class WjjApiParamsSupport {
    ...
    @Pointcut(value = "@annotation(com.plan.worker.framework.annotation.WjjApiParams)")
    public void access() {
    }
